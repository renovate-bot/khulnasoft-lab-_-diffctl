...
data "github_user" "chdorner-khulnasoft-lab" {
  username = "chdorner-khulnasoft-lab"
}
...
resource "github_team_membership" "chdorner-khulnasoft-lab" {
  team_id  = github_team.test.id
  username = data.github_user.chdorner-khulnasoft-lab.login
  role     = "maintainer"
}
